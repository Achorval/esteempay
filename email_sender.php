...
if($email_type == "password_resetted"):

$email = "<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Transitional//EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'><html xmlns='http://www.w3.org/1999/xhtml'><head><meta http-equiv='Content-Type' content='text/html; charset=utf-8' /><title>Untitled Document</title><style type='text/css'>@media screen and (max-device-width: 480px) and (orientation: portrait){.col-1{width:80%;padding:10px}}@media screen and (max-device-width: 640px) and (orientation: landscape){.col-1{width:80%;padding:10px}}@media screen and (max-device-width: 640px){.col-1{width:80%;padding:10px}}@media screen and (max-device-width: 960px){.col-1{width:80%;padding:10px}}.bg-light{background-color:#f8f9fa!important}.auto{margin-left:auto;margin-right:auto}.container{max-width:960px;margin-left:auto;margin-right:auto}.row{width:100%;display:block;padding:10px}.bg-white{background:#FFF}.border{border:1px solid #F7F7F7}.text-center{text-align:center}</style></head><body class='bg-light'><div class='container bg-light '><div class='row '><div class='col-1 bg-white auto'><p class='text-center '>You just changed your password.</p><p class='text-center '>If you didn't do so, contact our support by sending an email to support@esteem.finance</p><p class='text-center '>For any enquiry or further question, you can send us an email to support@esteem.finance</p></div></div></div></body></html>";

$data = array("personalizations"=>array(array("to"=>array(array("email"=>"$to","name"=>"")))),"subject"=>"[Esteem Finace] Password Changed Successfully","from"=>array("email"=>"no-reply@esteem.finance","name"=>"Esteem Finance"),"content"=>array(array("type"=>"text/html","value"=>"$email")));
