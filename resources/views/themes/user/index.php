					...
					<div class="portlet light ">
						...
						<div class="portlet-body">
							...
							<div class="table-scrollable table-scrollable-borderless">
								...
								<tr>
									<td class="fit">
										<img class="user-pic" src="<?php echo BASE_URL.ADMIN_THEME; ?>assets/admin/layout3/img/avatar4.jpg">
									</td>
									<td>
								...
								<tr>
									<td class="fit">
										<img class="user-pic" src="<?php echo BASE_URL.ADMIN_THEME; ?>assets/admin/layout3/img/avatar5.jpg">
									</td>
									<td>
								...
								<tr>
									<td class="fit">
										<img class="user-pic" src="<?php echo BASE_URL.ADMIN_THEME; ?>assets/admin/layout3/img/avatar6.jpg">
									</td>
									<td>
								...
								<tr>
									<td class="fit">
										<img class="user-pic" src="<?php echo BASE_URL.ADMIN_THEME; ?>assets/admin/layout3/img/avatar7.jpg">
									</td>
									<td>
							...
							<div class="scroller" style="height: 305px;" data-always-visible="1" data-rail-visible1="0" data-handle-color="#D7DCE2">
								<div class="general-item-list">
									<div class="item">
										<div class="item-head">
											<div class="item-details">
												<img class="item-pic" src="<?php echo BASE_URL.ADMIN_THEME; ?>assets/admin/layout3/img/avatar4.jpg">
									...
									<div class="item">
										<div class="item-head">
											<div class="item-details">
												<img class="item-pic" src="<?php echo BASE_URL.ADMIN_THEME; ?>assets/admin/layout3/img/avatar3.jpg">
									...
									<div class="item">
										<div class="item-head">
											<div class="item-details">
												<img class="item-pic" src="<?php echo BASE_URL.ADMIN_THEME; ?>assets/admin/layout3/img/avatar6.jpg">
												<a href="" class="item-name primary-link">Nick Larson</a>
									...
									<div class="item">
										<div class="item-head">
											<div class="item-details">
												<img class="item-pic" src="<?php echo BASE_URL.ADMIN_THEME; ?>assets/admin/layout3/img/avatar7.jpg">
												<a href="" class="item-name primary-link">Nick Larson</a>
									...
									<div class="item">
										<div class="item-head">
											<div class="item-details">
												<img class="item-pic" src="<?php echo BASE_URL.ADMIN_THEME; ?>assets/admin/layout3/img/avatar9.jpg">
									...
									<div class="item">
										<div class="item-head">
											<div class="item-details">
												<img class="item-pic" src="<?php echo BASE_URL.ADMIN_THEME; ?>assets/admin/layout3/img/avatar8.jpg">
									...
									<div class="item">
										<div class="item-head">
											<div class="item-details">
												<img class="item-pic" src="<?php echo BASE_URL.ADMIN_THEME; ?>assets/admin/layout3/img/avatar2.jpg">
					...
					<div class="portlet light ">
						...
						<div class="portlet-body">
							<div id="region_statistics_loading">
								<img src="<?php echo BASE_URL.ADMIN_THEME; ?>assets/admin/layout/img/loading.gif" alt="loading"/>
							</div>
