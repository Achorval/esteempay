...
<div class="page-header md-shadow-z-1-i navbar navbar-fixed-top">
	...
	<div class="page-header-inner">
		...
		<div class="page-logo">
			<a href="index.html">
			<img src="<?php echo BASE_URL.ADMIN_THEME; ?>assets/admin/layout4/img/logo-light.png" alt="logo" class="logo-default"/>
			</a>
			...
			<div class="top-menu">
				<ul class="nav navbar-nav pull-right">
							...
							<li>
								<ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
									<li>
										...
										<span class="photo">
										<img src="<?php echo BASE_URL.ADMIN_THEME; ?>assets/admin/layout3/img/avatar2.jpg" class="img-circle" alt="">
										</span>
										<span class="subject">
										<span class="from">
										Lisa Wong </span>
									...
									<li>
										<a href="inbox.html?a=view">
										<span class="photo">
										<img src="<?php echo BASE_URL.ADMIN_THEME; ?>assets/admin/layout3/img/avatar3.jpg" class="img-circle" alt="">
										</span>
										<span class="subject">
										<span class="from">
										Richard Doe </span>
									...
									<li>
										<a href="inbox.html?a=view">
										<span class="photo">
										<img src="<?php echo BASE_URL.ADMIN_THEME; ?>assets/admin/layout3/img/avatar1.jpg" class="img-circle" alt="">
										</span>
										<span class="subject">
										<span class="from">
										Bob Nilson </span>
					...
					<li class="dropdown dropdown-user dropdown-dark">
						...
						<img alt="" class="img-circle" src="<?php echo BASE_URL.ADMIN_THEME; ?>assets/admin/layout4/img/avatar9.jpg"/>
						</a>
						<ul class="dropdown-menu dropdown-menu-default">
							...
							<li>
								<a href="<?php echo BASE_URL; ?>AppAgent/logout">
