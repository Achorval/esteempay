...
?>
  ...
  <div class="col-md-7 mx-auto">
        <div class="section mt-2 text-center">
            ...
            <h4>Enter the password reset code you received in your email.</h4>
        </div>
        <div class="section mb-5 p-2">

            <form name="reset_password_form" id="reset_password_form" action="<?php echo BASE_URL; ?>processResetPassword" method="post">
                <div class="card">
                                <?php 
			if(isset($_GET['msg'])){
			if($_GET['msg']=="s"){
			...
			?>
                    ...
                    <div class="card-body pb-1">
                        ...
                        <div class="form-group basic">
                            <div class="input-wrapper">
                                <label class="label" for="email1">Reset Code</label>
                ...
                <div class="form-button-group  transparent">
                    <button type="submit" id="reset_password" class="btn btn-primary btn-block btn-lg">Reset Password</button>
                </div>
