...
<html lang="zxx" class="js">
   <head>
      ...
      <link rel="stylesheet" href="<?php echo BASE_URL.ACTIVE_THEME; ?>assets/css/style.css" id="layoutstyle">
               ...
               <div class="d-flex justify-content-between align-items-center">
                  <ul class="topbar-nav d-lg-none">
                     <li class="topbar-nav-item relative">
                        <a class="toggle-nav" href="index.html#">
                  ...
                  <!-- .topbar-nav --><a class="topbar-logo" href="index.html"><img src="images/logo-light2x.png" srcset="images/logo-light2x.png 2x" alt="logo"></a>
                  <ul class="topbar-nav">
                     <li class="topbar-nav-item relative">
                        <span class="user-welcome d-none d-lg-inline-block">Welcome! Stefan Harary</span><a class="toggle-tigger user-thumb" href="index.html#"><em class="ti ti-user"></em></a>
                        <div class="toggle-class dropdown-content dropdown-content-right dropdown-arrow-right user-dropdown">
                           ...
                           <ul class="user-links">
                              ...
                              <li><a href="index.html#"><i class="ti ti-infinite"></i>Referral</a></li>
               ...
               <div class="navbar-innr">
                  <ul class="navbar-menu">
                     ...
                     <li class="has-dropdown page-links-all">
                        <a class="drop-toggle" href="index.html#"><em class="ikon ikon-exchange"></em> Pages</a>
                        <ul class="navbar-dropdown">
                           <li class="has-dropdown">
                              <a class="drop-toggle" href="index.html#">Dashboards</a>
                              <ul class="navbar-dropdown">
                           ...
                           <li class="has-dropdown">
                              <a class="drop-toggle" href="index.html#">UI Elements</a>
                              <ul class="navbar-dropdown">
                           ...
                           <li class="has-dropdown">
                              <a class="drop-toggle" href="index.html#">Misc Pages</a>
                              <ul class="navbar-dropdown">
                           ...
                           <li class="has-dropdown">
                              <a class="drop-toggle" href="index.html#">KYC / AML</a>
                              <ul class="navbar-dropdown">
                           ...
                           <li class="has-dropdown">
                              <a class="drop-toggle" href="index.html#">User Pages</a>
                              <ul class="navbar-dropdown">
                           ...
                           <li class="has-dropdown">
                              <a class="drop-toggle" href="index.html#">Transactions</a>
                              <ul class="navbar-dropdown">
                           ...
                           <li class="has-dropdown">
                              <a class="drop-toggle" href="index.html#">Token Purchase</a>
                              <ul class="navbar-dropdown">
