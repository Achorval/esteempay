          ...
          <div class="col-md-12 col-sm-12">
            ...
            <div class="portlet box blue">
              ...
              <div class="portlet-body">
                  <a href="<?php echo BASE_URL; ?>AppAdmin/send_message" class="btn blue btn-block btn-sm" >Send message</a>
                  <hr />
  ...
  echo "".$last_thread->message."";
              ...
              <?php echo $last_thread->date_sent; //$value->phonenumber; ?>
                  ...
                  <td>
                      ...
                      <a href="view_thread.php?t=<?php echo $value->id; ?>" class="btn blue btn-block btn-sm" >View</a>
  ...
  System Messages
              ...
              <tbody>
                ...
                $user_id = $userdata['id'];
                  ...
                  $messages = $this->main_model->getUserMessages('system','');

                  foreach($messages as $key => $value){

  $last_thread = getLastThread($value->id);
