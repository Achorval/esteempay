		...
		<div class="page-content">
          ...
          <div class="portlet box green">
            									<div class="portlet-title">
            										<div class="caption">
            										Add a room to <?php echo $property['title']; ?>
            										</div>

            									</div>
            									<div class="portlet-body form">
            										<!-- BEGIN FORM-->
            										<form action="<?php echo BASE_URL; ?>AppAdmin/process_add_room" method="post" class="form-horizontal">
            											<div class="form-body">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                  <input type="text" class="form-control" id="title" placeholder="eg Standard Room" name="title" required>
                </div>
